...
public class CreateXLSX_1Md5 {

    public static void createXLSX(Map<String,String>map, File fi, File of, int size) throws IOException {
        ...
        try {
            ...
            for (int i = rowIndex; i < size; i++) {
                ...
                String s = map.get(stringCellValue);
                if (s != null && s != "") {
                    int cellNo = 1;
